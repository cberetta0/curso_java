public class AEjemplMatrices {
    public static void main(String[] args) {

        int[][] numeros = new int[2][4]; //new int[filas][columnas]
        ...
        System.out.println("cantidad de columnas: " + numeros[0].length); //podria hacer referencia tanto a la fila 0 como la 1
